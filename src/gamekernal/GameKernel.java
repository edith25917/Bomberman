...
//        g.setColor(Color.BLACK);
    ...
    public void run(boolean isDebug) {
        ...
        while (true) {
            long currentTime = System.nanoTime();// 蝟餌絞������
            long totalTime = currentTime - startTime;// 敺����蝬�����
            long targetTotalUpdated = totalTime / (nanosecPerUpdate);// �������府����活�
            // input
            // input end
            while (passedUpdated < targetTotalUpdated) {// 憒������活�撠撖阡��府閬���活�
                //update ��餈賭���活�
                if (cs != null) {
                    cs.update();
                }
